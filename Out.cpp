...
using namespace Out;
	...
	void Out::WriteAnalyze(OUT out, In::IN in, Log::LOG log)//убрать лог, возможно, добавить отдельную функцию дл€ анализа или просто улучш
	{
		int j=0;
		int chain = 0;
		*out.stream << "Ќачальные значени€ строк:" << IN_CODE_ENDL << in.text << IN_CODE_ENDL;
